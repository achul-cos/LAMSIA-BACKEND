...
class FactoryTemplate:
    def __init__(self, factory_name: str):
        self.factory_name = factory_name.lower()
        self.factory_file_name = ResourceName(self.factory_name).factory_file
        self.factory_class_name = ResourceName(self.factory_name).class_name
        self.factory_plural_name = ResourceName(self.factory_name).table_name

    def build(self, factory_fields:str = ""):
        return (f'''
# ------------------------------------------------------------------
# {self.factory_file_name}.py
# ------------------------------------------------------------------
...
from app.models.{self.factory_name}_model import {self.factory_class_name}
...
class {self.factory_class_name}Factory(BaseFactory):
    """
