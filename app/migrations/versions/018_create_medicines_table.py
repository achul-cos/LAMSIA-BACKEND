# ------------------------------------------------------------------
# 018_create_medicines_table.py
# ------------------------------------------------------------------
# Menjalankan migration pada model Medicine di database.
...
def downgrade(engine):
    ...
    """
    Schema("medicines").deleteColumns(engine, [
        #'atrribute1',
        #'atribute2',
    ])
    ...
    # Schema("medicines").deleteTable(engine)