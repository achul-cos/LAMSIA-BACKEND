# ------------------------------------------------------------------
# 020_create_riwayatkonsumsiobats_table.py
# ------------------------------------------------------------------
# Menjalankan migration pada model Riwayatkonsumsiobat di database.
...
def upgrade(engine):
    ...
    .build(engine)   
    """
    Schema("riwayatkonsumsiobats")\
        .id()\
        .int('kompartemen', nullable=False)\
...
def downgrade(engine):
    ...
    """
    # Schema("riwayatkonsumsiobats").deleteColumns(engine, [
    #     #'atrribute1',
    #     #'atribute2',
    # ])
    ...
    Schema("riwayatkonsumsiobats").deleteTable(engine)